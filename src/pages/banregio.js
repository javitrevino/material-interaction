...
const BanregioPage = ({ data }) => (
    <Layout>
        ...
        <ViewPrototype>
            <a className="AnchorInvisionWrapper" href="https://invis.io/A6R2N6VGCQ2" target="_blank">
        ...
        <CaseStudy>
            <p>
                La creación de micro-interacciones en el UI me permitió crear un sistema de navegación adecuada para la búsqueda de talleres asociados con la compañía. Haciendo así que el servicio de atención en el camino funcionara de maravilla.
            </p>
        </CaseStudy>

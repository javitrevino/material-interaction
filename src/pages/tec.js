...
const ProjectPage = ({ data }) => (
 ...
 y mostrar contenidos de educación financiera.
           </p>
            </div>
            <Wave />
        </div >
        ...
        <CaseStudy>
            <p>
                La selección de estilos y colores fue pensada en reflejar una especie de libreta virtual. Usé los colores de la identidad corporativa para seguir la misma linea que los demás productos de la universidad.
            </p>
            <p>
                En este tipo de aplicación el uso de tipografía y espacios negativos es super importante.
                Como no tenemos la ventaja de contenidos tan emocionantes, se buscó crear un diseño que hiciera uso de la simplicidad, que tuviera una gran consideración por una estética minimal y una experiencia en la que el contenido académico tomara el rol central.
        ...
        <ViewPrototype>
            <a className="AnchorInvisionWrapper" href="https://invis.io/DFR2N5H6SBZ" target="_blank">
        ...
        <CaseStudy>
            <p>
                Al mismo tiempo no quisé dejar de lado algunos detalles divertidos o amenos cómo animaciones en ciertas partes de la app como podemos ver en los ejemplos.
           </p>
        </CaseStudy>

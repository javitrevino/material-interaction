    ...
    <div className="Hero">
      <div className="HeroGroup">
        ...
        <p className="HeroParagraph">
          Contacta a interaction hoy para cotizar tu proyecto. Nos puedes contar
          de que trata tu proyecto de software en la forma de contacto y
          nosotros nos pondremos en contacto para cotizarte. También nos puede
          contactar en los siguientes canales:
        </p>
          ...
          <div>
            <svg width="20px" height="15px" viewBox="0 0 20 15">
              ...
              >
                <g
                  id="Mobile"
                  transform="translate(-253.000000, -242.000000)"
                  stroke="#FFFFFF"
                  stroke-width="2"
                >
                  <g id="mail" transform="translate(254.000000, 243.000000)">
                    <g id="Group">
                      <path
                        d="M18,2.93504308 L9.52627572,8.59910919 C9.18991233,8.82394357 8.75121317,8.82394357 8.41484977,8.59910919 L0,2.97439639 L0,1 C-6.76353751e-17,0.44771525 0.44771525,3.65416674e-15 1,3.55271368e-15 L17,3.55271368e-15 C17.5522847,3.45126062e-15 18,0.44771525 18,1 L18,2.93504308 Z"
                        id="Combined-Shape"
                      />
                      <rect
                        id="Rectangle-8"
            ...
            <a href="mailto:ventas@interaction.mx"> ventas@interaction.mx </a>
          </div>
        </div>
      </div>
      <Wave />

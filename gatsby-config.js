module.exports = {
  siteMetadata: {
    title: 'Interaction',
    description: 'Interaction asiste a las empresas de software en el diseño UI/UX, y prototipos interactives para ayudarles a crear apps increíbles. Nuestro propio método llamado Diseño Universal combina lo mejor del Diseño UI/UX y el Design Thinking para crear algo más efectivo.',
